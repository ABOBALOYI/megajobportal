...
(function(h) {
    ...
    function Ta(a, b, c) {
        var d = a._iDisplayStart,
            e = a._iDisplayLength,
            f = a.fnRecordsDisplay();
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 : "prev" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : K(a, 0, "Unknown paging action: " + b, 5);
    ...
    h.extend(Lb, {
        ...
        simple_numbers: function(a, b) {
            return ["prev", ia(a, b), "next"]
        },
        full_numbers: function(a, b) {
            return ["first", "prev", ia(a, b), "next", "last"]
        },
